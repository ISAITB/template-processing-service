...
public final class Utils {
    ...
    /**
     * Create the documentation for a processing operation.
     *
     * @param name The name of the operation.
     * @param input The list of expected inputs.
     * @param output The list of provided outputs.
     * @return The operation's definition.
     */
    public static ProcessingOperation createProcessingOperation(String name, List<TypedParameter> input, List<TypedParameter> output) {
